          ...
          <div id="layoutbox">
            ...
            <div id="main">
              ...
              <div id="text1">
                  ...
                  <p class="main_text_03">本当に腸内フローラを整えてくれる腸内スッキリサプリBEST4を公開！</p><br><br>

                  <div class="point_txt_top">

                  <span style="color:red; font-weight: bold;">
                  便秘の悩みから抜け出すために、菌活をする女性が増えています。</span>

                  なぜなら、薬などで解消する方法もありますが･･･<b>実はそれに頼りすぎると、さらに悪化</b>してしまいます。
                  そうならないために、<b>薬に頼らず</b>根本的な便秘解消ができるとして、<span style="color:red; font-weight: bold;">腸内フローラを整える菌活</span>
                  が様々なところで注目されているのです！<br><br>

                  といっても･･･腸内フローラを整えるためには
                  毎日善玉菌を増やすための食事や生活習慣を気にしなければいけません。
                  しかも、
                  <span style="color:blue;font-weight: bold;">腸内フローラを整える善玉菌のビフィズス菌や乳酸菌、酪酸菌は加齢と共に減少していきます。</span>
                  <br><br>

                  なので、<span style="color:red;font-weight: bold;" class="mk"> お手軽かつ経済的にサプリメントで毎日摂る！</span>
                  それが<b>最先端の便秘改善方法</b>なんです。
                ...
                <img src="./img/n_img/title_point_01_e.png" width="100%">
              ...
              <div class="img-center">
                <img src="./img/n_img/ranking__top—tame-4-pc.png" width="100%">
              </div>
