                    ...
                    <div id="main">
                        ...
                        <div id="text1">
                            ...
                            <div class="point_txt_top">
                                ...
                                しかも、<span
                                    style="color:blue;font-weight: bold;">年齢とともに善玉菌(やせ菌)は年齢と共に生産量も減り、少なくなっていきます。</span><br><br>

                                ヨーグルトや乳酸飲料、増やす料理など方法はありますが･･･<br>
                                手間やお金などを考えるとなかなか難しいものがあります。
                                <br>何より、<b>継続して摂取しなければ腸内環境の改善は難しい･･･。</b><br><br>

                                なので、<span style="color:red;font-weight: bold;" class="mk"> サプリメントを毎日摂取するのがおすすめです！
                                </span>
                                ですが、サプリメントによって品質はまちまち。<br>
                                <span
                                    style="color:red;font-weight: bold;">「乳酸菌(善玉菌)が配合されていればなんでも同じ」</span>って安易に選んで失敗したら意味がありません…。<br><br>
