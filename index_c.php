  ...
  <div id="wrapper">
    <div class="inner">
      <span class="img-center">
        <img src="./img/n_img/top_banner_01_c.png" width="100%" />
      </span>
          ...
          <div id="layoutbox">
            ...
            <div id="main">
              ...
              <div id="text1">
                    ...
                    <p class="main_text_01">「やせ菌を増やしてダイエットしたい」</p>
                ...
                <div class="point_txt_top">
                    ...
                    <span style="color:red; font-weight: bold;">最近話題の腸活！</span>
                    テレビや雑誌で、私達に与える様々な作用が話題になりましたよね。
                    <b><span style="color:red; " class="mk">やせ菌（善玉菌）を増やし、でぶ菌（悪玉菌）を減らして “腸内フローラ”のバランスを 
                    整えること</span>がダイエットや美容、健康のために重要</b>なのはあなたも知っているかもしれません。
                    <br>でも、善玉菌(やせ菌)を増やして悪玉菌を減らすのは簡単ではありません･･･。 
                    <br><br>

                    しかも、<span style="color:blue;font-weight: bold;">年齢とともに善玉菌(やせ菌)は年齢と共に生産量も減り、少なくなっていきます。</span><br><br>

                    ヨーグルトや乳酸飲料、増やす料理など方法はありますが･･･<br>
                    手間やお金などを考えるとなかなか難しいものがあります。 
                    <br>何より、<b>継続して摂取しなければ腸内環境の改善は難しい･･･。</b><br><br>

                    なので、<span style="color:red;font-weight: bold;" class="mk"> サプリメントを毎日摂取するのがおすすめです！ </span>
                    ですが、サプリメントによって品質はまちまち。<br>
                    <span style="color:red;font-weight: bold;" >「乳酸菌(善玉菌)が配合されていればなんでも同じ」</span>って安易に選んで失敗したら意味がありません…。<br><br>
                ...
                <img src="./img/n_img/title_point_01_c.png" width="100%">
