            ...
            <div id="layoutbox">
              <div id="main">
                ...
                <div class="point_txt_top">
                  ...
                  <span style="color:blue; font-weight:bold;">腸は『第二の脳』と呼ばれるくらい私の体で重要</span>です。
                  <br><br>

                  <!-- 腸が病原菌に感染すると、脳は不安を感じます。<br><br>
                  腸からホルモンが放出されると、脳は食欲を感じる･･･。<br><br>
                  <b style="color:red; font-weight: bold; font-size: 24px;">まさに「第2の脳」！</b><br><br> -->


                  <span style="color:blue; font-weight:bold;">国立がんセンターの統計では大腸ガンが２番目に死亡数が多いという発表が。</span><br>
                  腸内フローラの状態で、
                  <span style="color:red; font-weight: bold;">様々な病気の危険がとても高くなります。</span> しかも、善玉菌を増やす年齢と共に生産量も減り、少なくなっていく･･･。 
                  <br><br>

                  ヨーグルトや乳酸飲料、増やす料理など方法はありますが･･･<br><b>手間やお金などを考えるとなかなか難しい･･･。</b><br><br>
                  何より、<b>継続して摂取しなければ腸内環境の改善は難しい･･･。</b><br><br>

                  <span style="color:red; font-weight:bold;">なので、サプリメントを毎日摂取するのがおすすめです！</span><br>
                  <br>
                  ですが、サプリメントによって品質はまちまち。
                  <span style="font-weight: bold;">「乳酸菌(善玉菌)が配合されていればなんでも同じ」って安易に選んで失敗したら意味がありません…。</span><br><br>
                ...
                <div class="point_txt_middle">
                  <p>&nbsp;</p>
                  <p>そこで上記のチェック項目を元に「本当に飲んで満足できる乳酸菌サプリメント」を当サイトが独自調査しました。<br><br>
                  調査の結果選ばれた
