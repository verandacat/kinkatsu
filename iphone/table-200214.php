                    ...
                    <tr>
                      ...
                      <th style="background-color: #fff;">
                        ...
                        <p style="text-align: center">
                            ...
                            <strong>
                            <span style="font-size:13px" class="lbg">
                              <a target="_blank" href="http://xn--hdks4057bh4s.net/links/slilin.php<?php echo "?".$query2; ?>">善玉元気</a>
                            </span>
                          </strong>
                      ...
                      <th style="background-color: #fff">
                        ...
                        <p style="text-align: center">
                          <a target="_blank" href="http://xn--hdks4057bh4s.net/links/ec.php<?php echo "?".$query2; ?>">
                            <img src="./img/n_img/ec_new.png" alt="" />
                          </a>
                        </p>
                        <p style="text-align: center">
                          <strong>
                            <span style="font-size:13px" class="lbg">
                              <a target="_blank" href="http://xn--hdks4057bh4s.net/links/ec.php<?php echo "?".$query2; ?>">スリリンW</a>
                            </span>
                          </strong>
                        </p>
                        <p>&nbsp;</p>
