                ...
                <table class="dsc2item col4" cellspacing="1">
                  <tbody>
                    ...
                    <tr>
                        ...
                        <?php if(isset($_SESSION['switch']) && $_SESSION['switch'] == "on"){ ?>
                          <strong>
                            <span style="font-size:13px" class="lbg">
                              <a target="_blank" href="http://xn--hdks4057bh4s.net/links/lakubi_on.php<?php echo "?".$query2; ?>">LAKUBI(ラクビ)</a>
                            </span>
                          </strong>
                       <?php }elseif(isset($_SESSION['switch']) && $_SESSION['switch'] == "off"){ ?>
                           <strong>
                      ...
                      <?php }else{ ?>
                            <strong>
                            <span style="font-size:13px" class="lbg">
                              <a target="_blank" href="http://xn--hdks4057bh4s.net/links/lakubi.php<?php echo "?".$query2; ?>">LAKUBI(ラクビ)</a>
                            </span>
                          </strong>
                      <?php } ?>
                        </p>
                      ...
                      <th style="background-color: #fff">
                        ...
                        <p style="text-align: center">
                          <strong>
                            <span style="font-size:13px" class="lbg">
                              <a target="_blank" href="http://xn--hdks4057bh4s.net/links/bise.php<?php echo "?".$query2; ?>">くろしろ</a>
                            </span>
                          </strong>
                        </p>
                        <p>&nbsp;</p>
                  ...
                  <tr>
                    ...
                    <td>
                      <p>
                        <img src="./img/n_img/r_check_00.png" alt="" />
                      </p>
                    ...
                    <td>
                      ...
                      <span>2700円価格自体高いが安心の90日間全額返金保証付き</span>
                    </td>
                    <td>
                      <p>
                        <img src="./img/n_img/r_check_01.png" alt="" />
