          ...
          <div id="contents">
            <div id="layoutbox">
              ...
              <div id="text1">
                ...
                <p class="main_text_01" style="line-height:20px;">「デブ菌(悪玉菌)を減らして病気を予防したい」</p>
                <p class="main_text_02" style="padding-left:10px;"> とお悩みの方へ！</p>
                <p class="main_text_03"><b>本当に腸内フローラを整えてくれる<br>やせ菌サプリBEST4を公開！</b></p>
                ...
                <div class="point_txt_top">
                    ...
                    <span style="color:red; font-weight: bold;">最近話題の腸活！</span><br>
                     テレビや雑誌で、私達に与える様々な作用が話題になりましたよね。<br>
                    <span style="color:red; font-weight: bold;">やせ菌（善玉菌）を増やし、でぶ菌（悪玉菌）を減らして “腸内フローラ”のバランスを 整えること</span>
                    <span style="font-weight: bold;">がダイエットや美容、健康のために重要</span>あなたも知っているかもしれません。 <br><br>
                    でも、善玉菌(やせ菌)を増やして悪玉菌を減らすのは大変です･･･。  
                    <br><br>

                    しかも、<span style="color:blue;font-weight: bold;">年齢とともに善玉菌(やせ菌)は年齢と共に生産量も減り、少なくなっていきます。</span><br>

                    なにより･･･<span style="font-weight: bold;">改善しようとすると毎日ヨーグルトなどを食べないといけません･･･。</span><br>

                    なので、<span style="color:red;font-weight: bold;">サプリメントを毎日摂取するのがおすすめです！</span>
                ...
                <div class="point_txt_middle">
                  <p>&nbsp;</p>
                  <p>そこで上記のチェック項目を元に「本当に飲んで満足できる乳酸菌サプリメント」を当サイトが独自調査しました。<br><br>調査の結果選ばれた
              ...
              <div class="img-center">
                <img src="./img/n_img/ranking__top—debu-4-sp.png" width="100%">
              </div>
