            ...
            <div id="layoutbox">
              <div id="main">
                ...
                <div id="text1">
                  ...
                  便秘の悩みから抜け出すために、菌活をする女性が増えています。</span>><br>

                  薬などで解消する方法もありますが･･･<span style="font-weight: bold;">それに頼りすぎると、さらに悪化</span>することも。
                  なので、<span style="font-weight: bold;">薬に頼らず</span>根本的な便秘解消ができるとして、
                  <span style="color:red; font-weight: bold;">腸内フローラを整える菌活 が注目されいます！</span><br>

                  といっても･･･<b>腸内フローラを整えるためには
                  毎日善玉菌を増やすための食事や生活習慣を気にしなければいけません。</b><br><br>
                  しかも、
                  <span style="color:blue;font-weight: bold;">腸内フローラを整える善玉菌のビフィズス菌や乳酸菌、酪酸菌は加齢と共に減少していきます。</span>
                  <br><br>

                  でも、腸内フローラを整えるためには 毎日善玉菌を増やすための食事や生活習慣を気にしなければいけません。 <br>
                  しかも、 <span style="color:blue; font-weight:bold;">腸内フローラを整える善玉菌のビフィズス菌や乳酸菌、酪酸菌は加齢と共に減少していきます。
                  </span><br><br>

                  なので、<span style="color:red;font-weight: bold;">お手軽かつ経済的にサプリメントで毎日摂る！</span>
                  それが<span style="font-weight: bold;">最先端の便秘改善方法</span>なんです。
                ...
                <div class="point_txt_middle">
                  <p>&nbsp;</p>
                  <p>そこで上記のチェック項目を元に「本当に飲んで満足できる乳酸菌サプリメント」を当サイトが独自調査しました。<br>
                  調査の結果選ばれた
