                      ...
                      <tbody>
                        <tr>
                          <th style="position: relative;" class="ttitle" colspan="2">
                            ...
                            <img style="height: 90px; width: 90px; position: absolute; top:-10px;" alt="" src="./img/n_img/badge_ranking_0<?php echo $i; ?>.png" />
                            ...
                            <a target="_blank" href="<?php echo $offlink; ?><?php echo "?".$_SERVER['QUERY_STRING']; ?>" target="_blank">
                            <?php }else{ ?>
                            <a target="_blank" href="<?php echo $offlink; ?><?php echo "?".$_SERVER['QUERY_STRING']; ?>" target="_blank">
                            <?php } ?>
