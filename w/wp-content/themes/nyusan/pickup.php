...
<div class="pickupbox">
  ...
  <div id="sort4" class="sortonday">菌の含有量</div>
  <div id="sort5" class="sortvolume">菌の種類</div>
...
<div class="detailbox pickico">
  ...
  <div class="sp" style="clear:both"></div>
    <div class="detail">
      ...
      <div class="detailspecialprice"><div class="sp dtitle">菌の保有量</div><?php echo number_unit($contv); ?></div>
      <div class="detailvolume"><div class="sp dtitle">菌の種類</div><?php if(is_array($jenre)){
      ...
      <div class="detailurl pc"><a href="http://xn--hdks4057bh4s.net/<?php echo $url; ?><?php echo "?".$_SERVER['QUERY_STRING']; ?>" target="_blank"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/pickuplinkbutton.png" width="100%"></a></div>
     <p style="clear:both"></p>
      ...
      <div class="detailurl sp"><a href="http://xn--hdks4057bh4s.net/<?php echo $url; ?><?php echo "?".$_SERVER['QUERY_STRING']; ?>" target="_blank"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/sppickuplinkbutton.png" width="100%"></a></div>
    </div><!--detail-->
