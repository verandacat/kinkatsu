                ...
                <div id="layoutbox">
                    ...
                    <div id="main">
                        ...
                        <div id="text1">
                            ...
                            <p class="main_text_01">「毎朝、スッキリ出したい」</p>
                            <p class="main_text_01">「トイレの悩みから解放されたい」</p>
                            <p class="main_text_01">「けど、薬には頼りたくない」</p>
                            <p class="main_text_02" style="padding-left:10px;"> とお悩みの方へ！</p>
                            <p class="main_text_03"><b>本当に体内フローラを整えてくれるビフィズス菌サプリBEST4を公開！</b></p>


                            <div class="point_txt_top">

                                <span style="color:red; font-weight: bold;" class="mk">
                                    最近、様々な雑誌やテレビで注目されている体内フローラ。</span><br>

                                    そんな体内フローラを整え、体の調子を整える事ができると有名な<span
                                    style="color:red; font-weight: bold;">『ビフィズス菌』！</span><br>
                                    最近はヨーグルトなどにも『ビフィズス菌が摂れる！』と書かれていたり目にするとが多いですよね。
                                <span
                                    style="color: blue; font-weight: bold;">でも…実はヨーグルトなどで摂ってもあまり意味がないのを知っていましたか？</span><br><br>

                                <b>ビフィズス菌はとても胃酸に弱く、殆どが胃で死んでしまい腸に届かないのです･･･。<br>
                                    しかも、ビフィズス菌は加齢と共に減少してしまうことも研究でわかっています。</b><br><br>

                                <span style="color:red; font-weight: bold;"
                                    class="mk">ビフィズス菌には健康や美容でのいいことがいっぱい！</span><br>

                                    なので、しっかりと摂っていきたいものですよね。
                                    その方法としてオススメしたいのが、<b>サプリでの摂取！</b><br><br>

                                    ですが、サプリメントによって品質はまちまち。
                                <span style="color:red;font-weight: bold;">
                                    「乳酸菌が配合されていればなんでも同じ」って安易に選んで失敗したら意味がありません…。</span>
                            </div>
                            ...
                            <ul class="point_list">
                                ...
                                <li>
                                    <strong>
                                        <img src="./img/n_img/point_a_03.png" art="">菌が胃で死滅せずに体内へ届くようになっているか</strong>
                                </li>
                                <li>
                                    <strong>
                            ...
                            <p>
                                <strong>
                                    <span
                                        style="color: #3664f7">明日から変わり始めるあなたの健康生活のお手伝いをしてくれますので是非その満足度を体験してください。</span>
                                </strong>
                            </p>
                            <p>&nbsp;</p>
                        ...
                        <div class="img-center">
                            <img src="./img/n_img/ranking__top—tainai-4-pc.png" width="100%">
                        </div>
