  ...
  <tbody>
    ...
    <tr>
      ...
      <th style="background-color: #fff">
        ...
        <p>
          <strong>
            <span style="font-size:15px" class="lbg">
              <a target="_blank" href="http://xn--hdks4057bh4s.net/links/bise.php<?php echo "?" . $_SERVER['QUERY_STRING']; ?>">ビセラ</a>
            </span>
          </strong>
        </p>
      ...
      <th style="background-color: #fff">
        ...
        <p>
          <a target="_blank" href="http://xn--hdks4057bh4s.net/links/calg.php<?php echo "?" . $_SERVER['QUERY_STRING']; ?>">
        ...
        <p>
          <strong>
            <span style="font-size:15px" class="lbg">
              <a target="_blank" href="http://xn--hdks4057bh4s.net/links/calg.php<?php echo "?" . $_SERVER['QUERY_STRING']; ?>">カルグルト</a>
            </span>
          </strong>
        </p>
    ...
    <tr>
      ...
      <td>
        ...
        <span>安心の「GMP」基準に合格</span>
      </td>
      <td>
        <p>
          <img src="./img/n_img/r_check_01.png" alt="" />
        </p>
        <span>製法特許取得の乳酸菌発酵エキス</span>
      </td>
      <td>
        <p>
          <img src="./img/n_img/r_check_01.png" alt="" />
        ...
        <!-- <span>29種の乳酸菌</span> -->
        <span>5種の乳酸菌・ビフィズス菌配合。美容乳酸菌あり。</span>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        <span>耐久性の高いラクリス-S配合、吸収率まで高い</span>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        <!-- <span>有胞子性乳酸菌・酪酸菌・酵素など</span> -->
        <span>ビフィズス菌ビースリー、美容乳酸菌、ガセリ、ラクリス、ラブレ</span>
      </td>
    </tr>
