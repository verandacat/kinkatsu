  ...
  <div id="wrapper">
    <div class="inner">
      <span class="img-center">
        <img src="./img/n_img/top_banner_01_d.png" width="100%" />
      </span>
        ...
        <div id="contents">
          ...
          <div id="layoutbox">
            ...
            <div id="text1">
                  ...
                  <span style="color:red; font-weight: bold; font-size: 24px;">最近話題の菌活！</span><br>
                  私達の健康に大きく関係していると、様々なテレビや雑誌でも話題になりましたよね！<br>
                  <b><span style="color:blue;" class="mk">腸は『第二の脳』と呼ばれるくらい私の体で重要</span></b>です。
                  <br><br>

                  <!--腸が病原菌に感染すると、脳は不安を感じます。<br>
                  腸からホルモンが放出されると、脳は食欲を感じる･･･。<br>
                  <b style="color:red; font-weight: bold; font-size: 24px;">まさに「第2の脳」！</b><br><br>-->

                  <b><span style="color:blue;">そんな腸内で一番多いのは『日和見菌』</span></b><br>
                  日和見菌は名前の通り、<span style="text-decoration: underline;"><b>優勢な方の働きを助ける菌。</b></span><br>
                  なので、悪玉菌が少しでも有利なら腸内の環境は<b>あっという間に悪玉菌が優勢に。</b>
                  <span style="color:red;"><b>そうなると、様々な病気の危険がとても高くなります。</b></span>
                  しかも、善玉菌を増やす年齢と共に生産量も減り、少なくなっていく･･･。 
                  <br><br>

                  ヨーグルトや乳酸飲料、増やす料理など方法はありますが･･･<br><b>手間やお金などを考えるとなかなか難しい･･･。</b><br>
                  何より、<b>継続して摂取しなければ腸内環境の改善は難しい･･･。</b><br><br>

                  <b><span style="color:red; font-size: 24px;" class="mk">なので、 サプリメントを毎日摂取するのがおすすめです！</span></b><br>

                  ですが、サプリメントによって品質はまちまち。<br>
                  <b>「乳酸菌(善玉菌)が配合されていればなんでも同じ」って安易に選んで失敗したら意味がありません…。<br><br></b>
                ...
                <img src="./img/n_img/title_point_01_d.png" width="100%">
              ...
              <div class="img-center">
                <img src="./img/n_img/ranking__top—aku-4-pc.png" width="100%">
              </div>
